...
=========================================================
Reads from: RESULTS_DIR/daily_features.csv
Writes to:  RESULTS_DIR/changepoints_filtered.csv
"""
...
def cusum_changepoints(series, threshold=4.0, drift=0.5, min_segment=14):
    n = len(series)
    if n < 2 * min_segment:
        return []
...
def main():
    ...
    out = os.path.join(RESULTS_DIR, "changepoints_filtered.csv")
